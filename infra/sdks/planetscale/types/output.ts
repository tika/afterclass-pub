...
export interface GetBranchesBranch {
  /**
   * The access host URL for the branch. This is a legacy field, use <span pulumi-lang-nodejs="`mysqlEdgeAddress`" pulumi-lang-dotnet="`MysqlEdgeAddress`" pulumi-lang-go="`mysqlEdgeAddress`" pulumi-lang-python="`mysql_edge_address`" pulumi-lang-yaml="`mysqlEdgeAddress`" pulumi-lang-java="`mysqlEdgeAddress`">`mysql_edge_address`</span>.
   */
