...
var _packageRef: undefined | string;
  ...
  if (_packageRef === undefined) {
    ...
    if (_packageRef === undefined) {
      ...
      params.setValue(
        Uint8Array.from(
          atob(
            "eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BsYW5ldHNjYWxlL3BsYW5ldHNjYWxlIiwidmVyc2lvbiI6IjAuNi4xIn19",
          ),
          (c) => c.charCodeAt(0),
        ),
      );
